...
ROOT_NAME?=woodpecker-plugin-env

## MakeDocker.mk settings start
ROOT_OWNER?=woodpecker-kit
ROOT_PARENT_SWITCH_TAG =1.25.12
...
ENV_GO_GODOC_EXPORT_PKG =github.com/woodpecker-kit/woodpecker-plugin-env/
...
## build args start
ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-plugin-env/main.go
ENV_ROOT_BUILD_PATH =build
